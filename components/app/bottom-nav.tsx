        ...
        {navItems.map(({ href, label, icon: Icon }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "app-touch flex min-h-11 min-w-0 flex-1 items-center justify-center gap-2 rounded-2xl px-3 py-2.5 text-[11px] font-semibold transition-all duration-200 hover:-translate-y-0.5",
                active
